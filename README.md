...
* O τίτλος του commit (δλδ. η πρώτη γραμμή) πρέπει να είναι *περιγραφικός* και
  *σύντομος*. Ιδανικά, δε πρέπει να ξεπερνάει τους *50 χαρακτήρες*. Πρέπει να ξεκινάει με
  κεφαλαία και να είναι γραμμένος σε προστακτική ενεστώτα.
  Δε πρέπει να τελειώνει με τελεία.
...
* Υπάρχουν διάφορa workflows και καθένα από αυτά  έχει πλεονεκτήματα και μειονεκτήματα.
...
* Κρατάτε τα repository σας σε καλή κατάσταση με το να εκτελείτε τις παρακάτω
  maintenance εντολές, ανά τακτά χρονικά διαστήματα:
